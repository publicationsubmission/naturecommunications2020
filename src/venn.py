...
def venn3(labels, names=["A", "B", "C"], **options):
    ...
    dpi = options.get("dpi", 96)
    fontsize = options.get("fontsize", 14)
    setfontsize = options.get("setfontsize", 8)
    ...
    draw_text(fig, ax, 0.50, 0.27, labels.get("001", ""), fontsize=setfontsize)
    draw_text(fig, ax, 0.73, 0.65, labels.get("010", ""), fontsize=setfontsize)
    draw_text(fig, ax, 0.61, 0.46, labels.get("011", ""), fontsize=setfontsize)
    draw_text(fig, ax, 0.27, 0.65, labels.get("100", ""), fontsize=setfontsize)
    draw_text(fig, ax, 0.39, 0.46, labels.get("101", ""), fontsize=setfontsize)
    draw_text(fig, ax, 0.50, 0.65, labels.get("110", ""), fontsize=setfontsize)
    draw_text(fig, ax, 0.50, 0.51, labels.get("111", ""), fontsize=setfontsize)
